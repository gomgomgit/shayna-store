									...
									<table>
										...
										<tbody>
											<tr v-for="keranjang in keranjangUser" :key="keranjang.id">
												...
												<td @click="removeItem(index)" class="delete-item">
													<a href="#">
								...
								<div class="user-checkout text-left">
									<form>
										...
										<div class="form-group">
											...
											<input v-model="customerInfo.phone_number" type="text" class="form-control" id="noHP" aria-describedby="noHPHelp" placeholder="Masukan No. HP">
										</div>
										<div class="form-group">
...
export default {
    ...
    methods: {
		...
		checkOut(){
			...
			axios
			.post("http://128.199.98.129:445/api/checkout", checkoutData)
			.then(() => this.$router.push('success'))
			// eslint-disable-next-line no-console 
			.catch(console.log(checkoutData));
		},
	},
	computed: {
		totalHarga() {
